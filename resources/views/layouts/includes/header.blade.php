...
<head>
    ...
    <!-- END: Page CSS-->
        ...
        <link rel="stylesheet" href="{{ asset('app-assets/vendors/css/forms/pickers/form-flat-pickr.css')}}">
        <link rel="stylesheet" href="{{ asset('app-assets/vendors/css/forms/pickers/form-pickadate.css')}}">
